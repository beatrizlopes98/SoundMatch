...
const Match = () => {
    return(
        ...
        <View style={{flex:1, alignItems:'center', justifyContent:'center'}}>
            <View style={{width:300, height:340, marginBottom:10}}>
            ...
            <View>
                <Slider style={{width:350, height:40, marginTop: 25, flexDirection: 'row'}} value={10} minimumValue={0} maximumValue={100} thumbTintColor={COLORS.purple} minimumTrackTintColor={COLORS.purple} maximumTrackTintColor={COLORS.lavanda} onSlidingComplete={()=>{}}/>
